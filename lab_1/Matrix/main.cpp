...
void FillingMatrix(double (&matrix)[matrixSize][matrixSize],  ifstream& inputMatrix)
{
...
double CountDeterminant(double (&matrix)[matrixSize][matrixSize], double determinant)
{
